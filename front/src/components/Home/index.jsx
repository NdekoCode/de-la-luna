    ...
    <div className="card card-deal">
      ...
      <div className="row no-gutters items-wrap">
        <div className="col-md col-6">
          <figure className="card-product-grid card-sm">
            <a href="#" className="img-wrap">
              <img src={process.env.PUBLIC_URL + "assets/images/items/3.jpg"} />
            </a>
        ...
        <div className="col-md col-6">
          <figure className="card-product-grid card-sm">
            <a href="#" className="img-wrap">
              <img src={process.env.PUBLIC_URL + "assets/images/items/4.jpg"} />
            </a>
            <div className="text-wrap p-3">
              <a href="#" className="title">
                Some category
        ...
        <div className="col-md col-6">
          <figure className="card-product-grid card-sm">
            <a href="#" className="img-wrap">
              <img src={process.env.PUBLIC_URL + "assets/images/items/5.jpg"} />
            </a>
            <div className="text-wrap p-3">
              <a href="#" className="title">
                Another category
        ...
        <div className="col-md col-6">
          <figure className="card-product-grid card-sm">
            <a href="#" className="img-wrap">
              <img src={process.env.PUBLIC_URL + "assets/images/items/6.jpg"} />
            </a>
            <div className="text-wrap p-3">
              <a href="#" className="title">
                Home apparel
        ...
        <div className="col-md col-6">
          <figure className="card-product-grid card-sm">
            <a href="#" className="img-wrap">
              <img src={process.env.PUBLIC_URL + "assets/images/items/7.jpg"} />
            </a>
            <div className="text-wrap p-3">
