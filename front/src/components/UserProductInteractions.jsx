...
const UserProductInteractions = () => {
  return (
    <div className="flex justify-center">
      <Link
        className="relative text-gray-700 hover:text-gray-600 mx-1"
        href="#"
      >
        <svg
        ...
        <span className="absolute top-0 left-0 rounded-full animate-ping bg-indigo-500 text-white p-1 text-xs" />
      </Link>
      <Link
        className="relative text-gray-700 hover:text-gray-600 mx-1"
        href="#"
...
export default UserProductInteractions;
